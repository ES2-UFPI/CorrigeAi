...
import { News, NewsAuthor, NewsContainer, NewsContent, NewsTitle } from '../HomeClassStudent/styles'
import { Class, Classes, HomePage } from './styles'
