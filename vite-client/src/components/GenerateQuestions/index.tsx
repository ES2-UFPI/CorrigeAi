...
export function GenerateQuestions({
  ...
  const { questions, setQuestions, contQuestions, setContQuestions } =
  ...
  function handleOnChangeTypeQuestion(e: React.ChangeEvent<HTMLSelectElement>) {
  ...
  function handleOnChangeAnswer(e: React.ChangeEvent<HTMLTextAreaElement>) {
  ...
  function handleOnChangePoints(e: React.ChangeEvent<HTMLInputElement>) {
  ...
  return (
    <GenerateQuestionStyled className="question">
      ...
      <input
        ...
        type="number"
      />
      <ButtonDeleteQuestion onClick={handleDeleteQuestion}>
        Excluir
      </ButtonDeleteQuestion>
    </GenerateQuestionStyled>
  )
